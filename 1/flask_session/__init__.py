...
from .sessions import NullSessionInterface, SaeKVDBInterface,\
...
class Session(object):
    ...
    def _get_interface(self, app):
        ...
        config.setdefault('SESSION_KVDB', None)
        ...
        session_interface = SaeKVDBInterface(config['SESSION_KVDB'], config['SESSION_KEY_PREFIX'])

        #if config['SESSION_TYPE'] == 'kvdb':
        if 'kvdb'== 'kvdb':
            session_interface = SaeKVDBInterface(config['SESSION_KVDB'],
